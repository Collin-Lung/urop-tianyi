...
with open('C:/Users/colli/OneDrive - Massachusetts Institute of Technology/2022-2023 UROP Tianyi/'
          'Dimensionality Reduction/PCA/p5-w-last-seq-s15.txt') as p5:
    string_p5 = ''.join(p5)
...
plt.title('p5 PCA w/ last sequence from s15', fontsize=25)
...
seq1_indices_to_label = [9215]

for index, txt in enumerate(p5_pca):
    if index in seq1_indices_to_label:
        plt.annotate("seq", (p5_pca[index, 0], p5_pca[index, 1]))
